...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):        
        try:
            ...
            model_report:dict=evaluate_models(X_train=X_train, y_train=y_train, X_test=X_test, y_test=y_test, models=models, param=params)  #evaluating all the models and getting the r2 score of each model 
